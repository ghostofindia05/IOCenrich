#!/usr/bin/env bash
# IOCenrich — Frontend Startup (Production - Linux/macOS)
set -e
...
echo -e "\n============================================================"
echo -e "  IOCenrich — Frontend (Next.js Production Server)"
...
# ── Build Next.js ────────────────────────────────────────────
echo -e "${BLUE}[INFO] Building Next.js application for production...${NC}\n"
npm run build

# ── Start Next.js ────────────────────────────────────────────
echo -e "\n${BLUE}[INFO] Starting Next.js production server...${NC}"
