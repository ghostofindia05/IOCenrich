...
export async function POST(request: NextRequest) {
    try {
        ...
        // Sign up user using SuperTokens EmailPassword recipe
        ...
        // Create session
        await Session.createNewSession(baseRequest, baseResponse, "public", signupResponse.recipeUserId);
        
        const response = NextResponse.json({ user: signupResponse.user }, { status: 200 });
